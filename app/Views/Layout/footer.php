		...
		<div class="container pt-2 pb-4">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="row mb-2">
						<div class="col">
							<label class="mb-2">Temukan kami:</label>
							<table>
								<tr>
